...
const features = [
  {
    ...
    description: 'Reach your ideal local customers with precision targeting.'
  },
  {
    icon: DollarSign,
    title: 'Cost-Effective',
    description: 'Maximum impact with budget-friendly marketing solutions.'
  },
  {
    icon: Users2,
    title: 'Local Focus',
    description: 'Dominate your local market and build community presence.'
  },
  {
    icon: BarChart2,
    title: 'Growth Tracking',
    description: 'Monitor and measure your business growth metrics.'
  },
  {
    icon: Rocket,
    title: 'Quick Results',
  ...
  },
  {
    ...
    description: 'Grow your marketing strategy as your business expands.'
  }
];
...
const SmallBusiness = () => {
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <ParallaxSection
        imageUrl="https://images.unsplash.com/photo-1664575602554-2087b04935a5?auto=format&fit=crop&q=80"
        height="h-[600px]"
      >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-gray-600">
              See how we've helped small businesses thrive
            </p>
          </motion.div>
